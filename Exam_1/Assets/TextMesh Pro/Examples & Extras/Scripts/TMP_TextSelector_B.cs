...
namespace TMPro.Examples
{
    ...
    public class TMP_TextSelector_B : MonoBehaviour, IPointerEnterHandler, IPointerExitHandler, IPointerClickHandler, IPointerUpHandler
    {
        ...
        void RestoreCachedVertexAttributes(int index)
        {
            ...
            // Restore UV0S
            // UVS0
            Vector4[] dst_uvs0 = m_TextMeshPro.textInfo.meshInfo[materialIndex].uvs0;
            Vector4[] src_uvs0 = m_TextMeshPro.textInfo.meshInfo[materialIndex].uvs0;

            dst_uvs0[vertexIndex + 0] = src_uvs0[vertexIndex + 0];
            dst_uvs0[vertexIndex + 1] = src_uvs0[vertexIndex + 1];
            dst_uvs0[vertexIndex + 2] = src_uvs0[vertexIndex + 2];
            dst_uvs0[vertexIndex + 3] = src_uvs0[vertexIndex + 3];
            ...
            // UVS0
            src_uvs0 = m_cachedMeshInfoVertexData[materialIndex].uvs0;
            dst_uvs0 = m_TextMeshPro.textInfo.meshInfo[materialIndex].uvs0;
